...
public class SyncAdapter extends AbstractThreadedSyncAdapter {
	...
	public SyncAdapter(Context context, boolean autoInitialize) {
		...
		couchDb = CouchDbLiteStoreAdapter.get(getContext());
	...
	public void onPerformSync(Account account, Bundle bundle, String authority,
		...
		try {
			...
			Log.e("OnPerformSync", reportsToSync.toString());
	...
	private void handleException(String authtoken, Exception e,
		...
		} else if (e instanceof CouchbaseLiteException){
			Log.e("SyncAdapter", "CouchbaseLiteException", e);
		}
	}
	...
	private void updateSyncData(Report report, boolean synced) {
		couchDb.updateReportSyncStatus(report.getId(), synced);
	}
